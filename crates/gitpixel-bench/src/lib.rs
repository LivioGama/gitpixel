...
pub fn source_corpus(target_bytes: usize) -> Vec<u8> {
    let seed: &[&str] = &[
        include_str!("../../gitpixel-core/src/gram.rs"),
        include_str!("../../gitpixel-core/src/posting.rs"),
        include_str!("../../gitpixel-core/src/weights.rs"),
        include_str!("../../gitpixel-core/src/lib.rs"),
    ];
