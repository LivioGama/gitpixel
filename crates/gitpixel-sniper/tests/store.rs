...
use gitpixel_sniper::store::{Store, now_ms, project_key, store_directory, store_path};
use gitpixel_sniper::types::{
...
fn store_path_is_versioned_and_namespaced() {
    ...
    let expected: PathBuf = ["/state", "gitpixel", "sniper"]
        .iter()
        .collect::<PathBuf>()
