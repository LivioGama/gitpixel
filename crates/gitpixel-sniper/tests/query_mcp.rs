...
use gitpixel_sniper::store::{Store, now_ms};
use gitpixel_sniper::types::{ErrorInput, EventInput, EventKind, RunInput, Surface};
use gitpixel_sniper::{mcp, query};
...
fn mcp_server_info_identifies_the_server() {
    ...
    assert_eq!(info.server_info.name, "gitpixel-sniper");
